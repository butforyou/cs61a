...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    dream_score=abs(player_score//10%10-opponent_score%100//10)*3
    if dream_score>1:
        return dream_score
    else:
        return 1
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    score=0
    if num_rolls==0:
        score=boar_brawl(player_score,opponent_score)+player_score
    else:
        score=roll_dice(num_rolls)+player_score
    # END PROBLEM 4
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    while score0<goal or score1<goal:
      if who==0:
         ...
         print("the score0 is %d the score1 is: %d",score0,score1)
      else:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for player_score in range(0,goal):
        for opponent in range(0,goal):
            if strategy(player_score,opponent)!=a:
                flag=False
    return flag
    # END PROBLEM 7
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    if sus_update(score,opponent_score)-score>=threshold:
        return 0
    else:
        return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    f=make_averaged(roll_dice,1000)
    threshold=f(6)
    if sus_strategy(score,opponent_score,threshold)==0 or boar_brawl(score,opponent_score,threshold)==0:
        return 0
    else:
